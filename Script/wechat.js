...
(function() {
    ...
    if ((url.includes("/xpg.html") && method === "GET") && (url.includes("175.178.221.123:80") || url.includes("23.224.81.94:80"))) {
        // 动态获取当前 UTC 时间
        const now = new Date();
...
<h3>404，您请求的文件不存在!</h3>
        ...
        response = {
            ...
            body: `ovhZc8c+BRrptq3lovODCdStwCzhpFP3POyauoJoz9Vb1AGHQ+L0osL20vg4GRSI`
        };
    }
